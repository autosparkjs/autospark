      ...
      "/zh/": [
          ...
          items: [
            ...
            { text: "指令", link: "/zh/guide/directive" },
            {
              ...
              items: [
                ...
                { text: "样式", link: "/zh/guide/component/styles" },
                { text: "远程组件", link: "/zh/guide/component/remote" },
                { text: "配置选项", link: "/zh/guide/component/options" },
                { text: "注意事项", link: "/zh/guide/component/notes" },
                { text: "常见问题", link: "/zh/guide/component/faq" },
              ],
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "x-for",
              link: "/zh/guide/directives/x-for",
              collapsed: true,
              items: [
    ...
    plugins: [
      {
        ...
        configureServer(server: any) {
          ...
          const ctxPromise = context({
            entryPoints: [path.resolve(__dirname, "../../../packages/engine/src/index.ts")],
            bundle: true,
            format: "iife",
          ...
          server.middlewares.use((req: any, res: any, next: any) => {
            if (req.url?.split("?")[0] !== "/autospark/autospark.js") return next();
